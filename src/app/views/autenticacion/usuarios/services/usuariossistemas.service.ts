...
export class UsuariosSistemasService {
    ...
    return new Observable((o) => {
      setTimeout(() => {
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/usuariossistemas/getAdmin',
  ...
  public getAdmin(dataTablesParameters): Observable<any> {
    return this.http.post(this.API_URL + '/usuariossistemas/getAdmin',
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/usuariossistemas/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/usuariossistemas/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }

  public getRecordTitularEnLicencia( id_catplanteles, id_gruposclase,id_materiasclase,id_semestre): Observable<any> {
    return this.http.post(this.API_URL + '/usuariossistemas/getRecordTitularEnLicencia',
  ...
  public open(id: string, accion: string, idItem: number, idUsuario: number) {
    let modal: any = this.modals.filter(x => x.id === id)[0];
    modal.open(idItem, accion, idUsuario);
  }
